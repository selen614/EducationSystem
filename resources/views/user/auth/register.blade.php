                    ...
                    <form method="POST" action="{{ route('user.show.register') }}">
                        ...
                        <div class="center">
                            <div class="col-md-6">
                                ...
                                @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="email" autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name_kana') is-invalid @enderror" name="name_kana" value="{{ old('name_kana') }}" autocomplete="email" autofocus>
